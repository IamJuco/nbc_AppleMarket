...
fun returnDummyData(): List<PostModel> {
    ...
    dummyItems.add(
        PostModel(
            "미니멀하게",
            Uri.parse("android.resource://com.example.nbc_market/drawable/sample6"),
            "프라다 복조리백",
            "까임 오염없고 상태 깨끗합니다\n정품여부모름",
            "연제구 연산제8동",
            50000,
    ...
    dummyItems.add(
        PostModel(
            "굿리치",
            Uri.parse("android.resource://com.example.nbc_market/drawable/sample7"),
    ...
    dummyItems.add(
        PostModel(
            "난쉽",
            Uri.parse("android.resource://com.example.nbc_market/drawable/sample8"),
            "샤넬 탑핸들 가방",
    ...
    dummyItems.add(
        PostModel(
            "알뜰한",
            Uri.parse("android.resource://com.example.nbc_market/drawable/sample9"),
            "4행정 엔진분무기 판매합니다.",
    ...
    dummyItems.add(
        PostModel(
            "똑태현",
            Uri.parse("android.resource://com.example.nbc_market/drawable/sample10"),
            "셀린느 버킷 가방",
